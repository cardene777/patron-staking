...
>>>>>>> origin/feature/20231020_frontend
  ...
  const onSubmit = async (e: any) => {
    e.preventDefault();
<<<<<<< HEAD
    if (Name !== "" && ProfileImage !== "" && Whatdoyoudo !== "" && WalletAddress !== "" && Description !== "") {
      setIsSubmitted(true);
=======
    if (
      name &&
...
<<<<<<< HEAD
            ...
            <div className="md:flex md:items-center mb-6">
              <div className="md:w-1/3">
                ...
                <button type="button" onClick={signInWithTwitter} className="text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mr-2 mb-2">
                ...
                <button type="button" onClick={signInWithGithub} className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
